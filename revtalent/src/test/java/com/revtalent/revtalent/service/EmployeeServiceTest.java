...
class EmployeeServiceTest {
    ...
    class GetTeam {
        ...
        void returnsListWhenEmployeesExist() {
            ...
            List<EmployeeResponse> result = employeeService.getTeam();

            assertThat(result).hasSize(1);
            EmployeeResponse r = result.get(0);
    ...
    class SearchTeam {
        ...
        void returnsMatchesForQuery() {
            ...
            List<EmployeeResponse> result = employeeService.searchTeam("JOHN");
        ...
        void returnsEmptyWhenNoMatch() {
            ...
            List<EmployeeResponse> result = employeeService.searchTeam("xyz");
